...
Documentación de flujo de trabajo remoto con GIT en ECLIPSE
...
El primer paso es hacer "Fork" del repositorio. https://github.com/RiskAdventure/RiskEclipse.git
...
`$ git remote add upstream https://github.com/RiskAdventure/RiskEclipse.git`
